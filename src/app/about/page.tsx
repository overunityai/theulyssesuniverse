...
const OTHER_BOOKS = [
  ...
  {
    title: "Ethical AI",
    subtitle: "Governing AI Before It Governs You",
    tagline: "A working guide to governing AI before it governs you.",
    audience: "C-suite, boards, business owners, P&L owners",
    blurb:
      "When an AI system causes harm, the law looks for a person. Not a model. In 2024 a tribunal held Air Canada responsible for what its chatbot told a customer. That precedent is now one of dozens. Written for the person who owns the P&L, signs the procurement, or carries the legal exposure. Includes the Three Lines of Defence applied to AI, the EU AI Act in plain terms, and a 90-day governance starter.",
    amazonUrl: "https://a.co/d/09Pc24e5",
    cover: "/images/other-books/ethical-ai.webp",
  },
  {
    title: "AI Moats",
    subtitle: "Building a Defensible Advantage in the Age of AI",
    tagline: "Where durable AI advantage actually comes from.",
    audience: "Founders, investors, operators",
    blurb:
      "Spending the most on AI compute is not a moat. It is a cost. In one week of January 2025, a Chinese lab matched the Western frontier at a fraction of the cost, and Nvidia lost close to $600 billion of market value in a single day. AI Moats sets out the four currencies of real advantage - data, compute, distribution, and trust - and the six-question diligence framework for telling a real moat from a marketing story.",
    amazonUrl: "https://a.co/d/0g5lSbXl",
    cover: "/images/other-books/ai-moats.webp",
  },
  {
    title: "TRANSFORM",
    subtitle: "Delivering AI Transformation When Most Fail",
    tagline: "A nine-step framework for AI transformation that aims at business results, not demos.",
    audience: "C-suite, transformation leaders, AI programme owners",
    blurb:
      "Most AI transformations fail. Not on the technology - on everything around it. MD Anderson shelved a reported $62 million Watson programme. Zillow wrote down more than half a billion after letting an algorithm price homes. The tech worked; the transformation didn't. TRANSFORM is the nine-step framework for the executive who has to make the call on Tuesday and answer for it at the next board meeting - not for the data-science team.",
