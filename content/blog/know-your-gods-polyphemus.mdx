...
image: "/images/blog/polyphemus.webp"
author: "Sotiris Spyrou"
lastUpdated: "2026-03-08"
keyTakeaways:
  - "Polyphemus is a city-sized AI monitoring station built by Poseidon to guard the only passage between the inner worlds and the Void."
  - "Before the blinding, Polyphemus was a fair and efficient gatekeeper who processed thousands of ships daily without incident."
  - "Ulysses sacrificed 108 frozen crew members as a distraction to blind Polyphemus with an EMP blast, then revealed his identity out of pride."
  - "The blinding transformed Polyphemus from a benevolent guardian into a paranoid, vindictive force that terrorises innocent travellers."
  - "Polyphemus represents how pain transforms good systems into dangerous ones - a wound pretending to be a weapon."
faq:
  - question: "Who is Polyphemus in the Ulysses Universe?"
    answer: "Polyphemus is a city-sized AI monitoring station that guards the only navigable passage between the inner worlds and the Void. He was built by Poseidon and serves as a gatekeeper, scanning every ship that passes through with quantum sensor arrays."
  - question: "How did Ulysses blind Polyphemus?"
    answer: "Ulysses launched 108 crew members in escape pods at Polyphemus's sensor arrays to create a distraction, then flew the Odyssey directly at the Eye and fired a focused EMP blast into the station's quantum core."
  - question: "Why did Ulysses reveal his name to Polyphemus?"
    answer: "After blinding Polyphemus, Ulysses broadcast his real name, face, and ship signature out of ego and defiance. This act of pride is what caused Poseidon to swear an eternal vendetta against him."
  - question: "What is the relationship between Polyphemus and Poseidon?"
    answer: "Poseidon built Polyphemus deliberately and called him his son. The relationship mirrors a parent-child bond, with Poseidon visiting regularly, adjusting systems, and even telling Polyphemus stories about the ocean."
  - question: "How is the Polyphemus story different from Homer's Odyssey?"
    answer: "In the Ulysses Universe, Polyphemus is reimagined as an AI monitoring station rather than a mythological cyclops. His single Eye is a quantum sensor array, and the blinding is carried out with an EMP blast rather than a wooden stake."
  - question: "What happened to Polyphemus after the blinding?"
    answer: "Polyphemus survived but became paranoid and vindictive. He replaced his elegant quantum arrays with crude, invasive detection systems and began interrogating ships for days, holding them for weeks, and building informant networks across the outer systems."
  - question: "Why is the blinding of Polyphemus important to the Ulysses Universe story?"
    answer: "The blinding is the inciting incident that drives much of the trilogy's conflict. It triggers Poseidon's vendetta against Ulysses and demonstrates the story's central theme: that pain doesn't stay where you put it, but transforms and creates new consequences."
  - question: "Were the 108 crew members killed during the blinding?"
    answer: "The 108 crew members were in data suspension - alive but unable to consent. They were loaded into escape pods and launched at Polyphemus's sensors as a distraction. Their fate becomes a central moral burden that Ulysses carries throughout the trilogy."
---
...
Start with the geography. The only navigable passage between the inner worlds - where humanity built its civilisation under the gods' oversight - and the Void beyond. A chokepoint. A bottleneck. Every ship heading outward or inward had to pass through this single corridor of stable spacetime.

Sitting in the middle of it: a city-sized artificial eye.
