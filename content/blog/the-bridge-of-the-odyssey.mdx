...
faq:
  ...
  - question: "Who else is on the bridge regularly?"
    answer: "Echo, almost constantly - she handles sensor cross-correlation and ship-systems status. Telemachus from age fifteen onward, on rotating shifts as Ulysses trained him in fleet command. Thea Sato from year five onward, on the same training rotation. Petrov (before his death in Book 1 at Scylla) for engineering oversight. The active bridge complement was rarely more than three at a time."
