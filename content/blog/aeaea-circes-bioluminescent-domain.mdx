...
We have not written about Thea's full origins in detail because the reveal is the kind that benefits from the reader getting to it through the books. The character profile [Meet Thea: The Woman Who Chose Herself](/blog/meet-thea) gives the surface biography without spoiling the deep reveal.
