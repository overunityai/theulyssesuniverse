...
The Ulysses Universe trilogy preserves the structural elements of the Odyssey while updating the setting to a 23rd-century space opera. The Telemachy is partially preserved (Telemachus's coming-of-age across the trilogy). The flashback structure is preserved (Book 1 opens with the Olympus escape in flashback). The major waypoints map to specific science-fictional locations.

For the trilogy's canonical timeline, see [Twenty Years on the Odyssey: The Master Timeline](/blog/twenty-years-on-the-odyssey-master-timeline). For specific waypoints in our version, the Behind the Scenes category contains location features.
