...
faq:
  ...
  - question: "Where does the Ulysses Universe trilogy fit on a list of Odyssey retellings?"
    answer: "The Ulysses Universe is the contemporary science-fiction reimagining of the Odyssey. Where Miller's Circe centres on Circe, where Atwood's Penelopiad centres on Penelope, the Ulysses Universe centres on Ulysses Theron and updates the entire setting to a 23rd-century space opera. The Pantheon are quantum-AI entities. The Cyclops is an AI warden of a prison-asteroid. The Sirens are a signal that rewrites memory. The thematic content is unchanged. The infrastructure is."
---
...
The science-fiction option. The Ulysses Universe trilogy reimagines the entire Odyssey as 23rd-century space opera. Ulysses Theron is a fleet admiral. The gods are quantum-AI entities running on infrastructure that pre-dates humanity. Polyphemus is an asteroid-prison with an AI warden that has been alone for forty-seven years.
