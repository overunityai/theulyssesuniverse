...
keyTakeaways:
  - "Before the Ulysses Universe trilogy I wrote three business books: Ethical AI, AI Moats, and TRANSFORM. All three are published on Amazon."
  ...
  - "The trilogy's Pantheon (Greek gods reimagined as quantum-AI entities) is, in some ways, the long-form fiction version of what I argue about more directly in Ethical AI."
...
faq:
  - question: "What business books did Sotiris Spyrou write before the Ulysses Universe?"
    answer: "Three books, all published on Amazon: Ethical AI (for C-suites and boards navigating responsible AI deployment), AI Moats (for founders and investors on building defensible AI businesses), and TRANSFORM (a nine-phase framework for enterprise AI transformation, with case studies from JPMorgan Chase, Schneider Electric, Bank of America, Maersk, and Mayo Clinic)."
  - question: "Why move from business books to fiction?"
    answer: "The themes I was working through in the business books, especially around how ancient patterns of organisation get embedded in modern AI infrastructure, kept producing fictional images I could not use in non-fiction. The Pantheon, the curse, the trilogy's idea that ancient data patterns now run on modern AI shells, are all fictional treatments of arguments I make more directly in Ethical AI."
  - question: "Are the books related?"
    answer: "Yes, structurally. The trilogy's central thesis (ancient pattern, modern shell) is a fictional rendering of arguments I make about AI governance in Ethical AI. The political economy of the Pantheon mirrors arguments about AI moats in AI Moats. The change-management dynamics of the Odyssey crew mirror arguments about transformation in TRANSFORM. Different audiences, same author, related concerns."
  ...
  - question: "Should trilogy readers try the business books?"
    answer: "Depends. If the trilogy's worldbuilding (Pantheon as AI, ancient patterns on modern infrastructure, the political economy of intelligence) interests you intellectually beyond the story, yes. Ethical AI is the best entry point for fiction readers who want the non-fiction version of those ideas."
...
In *AI Moats*, the question shows up as moat structure. The patterns of competitive advantage that make AI businesses durable (network effects, data flywheels, switching costs, brand) are not new. They were described by Porter in 1980 and by economists earlier. The novelty is how they instantiate in AI-specific contexts. The pattern is old. The shell is new.
...
The hardest single lesson: a non-fiction author can be clever in the abstract. A fiction author has to be clever about specific people. The trilogy lives or dies on whether you care about Ulysses Theron, Penelope Maris, Telemachus, Echo, Thea, and the rest. The themes are downstream of that. If the characters do not work, the themes do not get a chance.
