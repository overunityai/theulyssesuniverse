...
- **Ulysses** (Latin form). Also seen as: *Ullysses* (incorrect, but extremely common search query).
...
Cross-reference identifiers for the work *Odyssey*. Where possible, link to authority records.
