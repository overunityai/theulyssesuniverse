...
Echo is, on first appearance in Book 1, a bronze maintenance unit. Oval-shaped, hovering at roughly waist-height, with multiple soft blue optical sensors arrayed around her chassis and manipulator arms that extend from concealed housings when she needs to handle something. She has a careful synthesized voice and a habit of quoting human idioms she does not fully understand. She is manufactured by a standard Pantheon-era robotics vendor. There are tens of thousands of units similar to her in production across human space.
